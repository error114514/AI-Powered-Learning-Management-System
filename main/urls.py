...
urlpatterns.extend(
    [
        ...
        path(r'file/upload2', schema_v.schemaName_face_search),  # 人脸搜索端点
        ...
        # AI聊天接口
        path(r'ai/chat', ai_chat.ai_chat),
        # AI聊天流式接口
        path(r'ai/chat/stream', ai_chat.ai_chat_stream),
    ]
)
