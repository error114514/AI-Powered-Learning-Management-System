...
class BaseModel(models.Model):
    ...
    def __CreateByReq(self, model, params):
        ...
        :return:
        '''
        params['addtime'] = datetime.datetime.now()
...
class Attendance(models.Model):
    ...
    method = models.CharField(max_length=50, default='normal_sign_in')
    source_image_id = models.CharField(max_length=255, null=True, blank=True)
    status = models.CharField(max_length=20, default='signed_in')

    def __str__(self):
        return f"Attendance {self.id} - Course {self.course_id} - Student {self.student_id}"
