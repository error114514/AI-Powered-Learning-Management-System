          ...
          <el-form-item class="input" v-if="ruleForm.shijian" label="时间" prop="shijian">
              <el-input v-model="ruleForm.shijian" 
                placeholder="时间" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="提问" prop="tiwen">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="提问"
                  v-model="ruleForm.tiwen" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tiwen" label="提问" prop="tiwen">
                    <span>{{ruleForm.tiwen}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
