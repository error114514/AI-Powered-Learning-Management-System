...
CREATE TABLE `examrecord`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1613791334318 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '作业记录表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `shishengjiaoliu` VALUES (53, '2025-12-15 11:01:36', '学号3', '姓名3', '高校课程中的大学英语四级考核标准是什么？', '2025-12-15 11:01:36', '是', '高校课程中的大学英语四级考核标准参考全国大学英语四、六级作业大纲，包含听力、阅读、写作、翻译四大类。');
